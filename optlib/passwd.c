/*
 * Generated by ./misc/optlib2c from optlib/passwd.ctags, Don't edit this
 * manually.
 */
#include "field.h"
#include "general.h"
...
extern parserDefinition *PasswdParser(void) {
  ...
  static const char *const patterns[] = {"passwd", NULL};
  ...
  static tagRegexTable PasswdTagRegexTable[] = {
      {"^([^:]+):([^:]+):([^:]+):([^:]+):([^:]*):([^:]+):([^:]+)", "\\1", "u",
       "{_field=home:\\6}{_field=shell:\\7}", NULL, false},
  };
