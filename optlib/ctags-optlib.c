/*
 * Generated by ./misc/optlib2c from optlib/ctags-optlib.ctags, Don't edit this
 * manually.
 */
#include "field.h"
#include "general.h"
...
extern parserDefinition *CtagsParser(void) {
  static const char *const extensions[] = {"ctags", NULL};
  ...
  static tagRegexTable CtagsTagRegexTable[] = {
      {"^--langdef=([^ \t]+)$", "\\1", "l", "{scope=set}", NULL, false},
      {"^--regex-[^=]+=.*/.,(.+)/.*", "\\1", "k", "{scope=ref}", NULL, false},
      {"^--kinddef-[^=]+=.,([^,]+),.*", "\\1", "k", "{scope=ref}", NULL, false},
  };
