...
extern parserDefinition *ManParser(void) {
  static const char *const extensions[] = {"1",     "2",     "3", "4", "5",
                                           "6",     "7",     "8", "9", "3pm",
                                           "3stap", "7stap", NULL};
  ...
  static tagRegexTable ManTagRegexTable[] = {
      {"^\\.TH[[:space:]]{1,}\"([^\"]{1,})\".*", "\\1", "t",
       "{exclusive}{icase}{scope=push}", NULL, false},
      {"^\\.TH[[:space:]]{1,}([^[:space:]]{1,}).*", "\\1", "t",
       "{exclusive}{icase}{scope=push}", NULL, false},
      {"^\\.SH[[:space:]]{1,}\"([^\"]{1,})\".*", "\\1", "s",
       "{exclusive}{icase}{scope=ref}", NULL, false},
      {"^\\.SH[[:space:]]{1,}([^[:space:]]{1,}).*", "\\1", "s",
       "{exclusive}{icase}{scope=ref}", NULL, false},
  };
