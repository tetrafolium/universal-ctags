/*
 * Generated by ./misc/optlib2c from optlib/qemuhx.ctags, Don't edit this
 * manually.
 */
#include "field.h"
#include "general.h"
...
extern parserDefinition *QemuHXParser(void) {
  ...
  static kindDefinition QemuHXKindTable[] = {
      {
          ...
          'q',
          "qmp",
          "QEMU Management Protocol dispatch table entries",
      },
      {
          true,
          'i',
  ...
  static tagRegexTable QemuHXTagRegexTable[] = {
      {"^SQMP[[:space:]]([-a-z_0-9A-Z]+)[[:space:]]---", "\\1", "q",
       "{mgroup=1}", NULL, true},
      {"^SQMP[[:space:]]([-a-z_0-9A-Z]+)[[:space:]]---", "qmp_\\1", "q",
       "{mgroup=1}{_extra=funcmap}", NULL, true},
      {"^@item[[:space:]]{1,}([-.a-z_0-9A-Z]{1,})", "\\1", "i", NULL, NULL,
       false},
  };
