/*
 * Generated by ./misc/optlib2c from optlib/inko.ctags, Don't edit this
 * manually.
 */
#include "field.h"
#include "general.h"
...
static void initializeInkoParser(const langType language) {
  ...
  addLanguageTagMultiTableRegex(language, "toplevel", "^\\}", "", "",
                                "{scope=pop}", NULL);
  addLanguageTagMultiTableRegex(language, "toplevel", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "object",
                                "^([A-Z][a-zA-Z0-9_?]*)[^{]*", "\\1", "o",
                                "{scope=push}", NULL);
  addLanguageTagMultiTableRegex(language, "object", "^\\{", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "object", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "trait",
                                "^([A-Z][a-zA-Z0-9_?]*)[^{]*", "\\1", "t",
                                "{scope=push}", NULL);
  addLanguageTagMultiTableRegex(language, "trait", "^\\{", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "trait", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(
      language, "method",
      "^([a-zA-Z0-9_?]+|\\[\\]=?|\\^|&|\\||\\*|\\+|\\-|/|>>|<<|%)[^{]*", "\\1",
      "m", "{scope=push}", NULL);
  addLanguageTagMultiTableRegex(language, "method", "^\\{", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "method", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "comment", "^\n", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "comment", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "impl",
                                "^([A-Z][a-zA-Z0-9_?]*)[[:blank:]]+for[[:blank:"
                                "]]+([A-Z][a-zA-Z0-9_?]*)[^{]*",
                                "\\2", "r",
                                "{scope=push}{_field=implements:\\1}", NULL);
  addLanguageTagMultiTableRegex(language, "impl", "^([A-Z][a-zA-Z0-9_?]*)[^{]*",
                                "\\1", "r", "{scope=push}", NULL);
  addLanguageTagMultiTableRegex(language, "impl", "^\\{", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "impl", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "let", "^(@[a-zA-Z0-9_]+)", "\\1",
                                "a", "{scope=ref}", NULL);
  addLanguageTagMultiTableRegex(language, "let", "^([A-Z][a-zA-Z0-9_]+)", "\\1",
                                "c", "{scope=ref}", NULL);
  addLanguageTagMultiTableRegex(language, "let", "^=", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "let", "^.", "", "", "", NULL);
}

extern parserDefinition *InkoParser(void) {
  static const char *const extensions[] = {"inko", NULL};
