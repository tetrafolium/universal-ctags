/*
 * Generated by ./misc/optlib2c from optlib/gdbinit.ctags, Don't edit this
 * manually.
 */
#include "field.h"
#include "general.h"
...
extern parserDefinition *GdbinitParser(void) {
  static const char *const extensions[] = {"gdb", NULL};

  static const char *const aliases[] = {NULL};

  static const char *const patterns[] = {".gdbinit", NULL};
  ...
  static tagRegexTable GdbinitTagRegexTable[] = {
      ...
      {"^define[[:space:]]+([^[:space:]]+)$", "\\1", "d", NULL, NULL, false},
      {"^document[[:space:]]+([^[:space:]]+)$", "\\1", "D", NULL, NULL, false},
      {"^set[[:space:]]+\\$([a-zA-Z0-9_]+)[[:space:]]*=", "\\1", "t", NULL,
       NULL, false},
