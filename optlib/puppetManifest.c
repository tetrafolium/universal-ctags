/*
 * Generated by ./misc/optlib2c from optlib/puppetManifest.ctags, Don't edit
 * this manually.
 */
#include "field.h"
#include "general.h"
...
static void initializePuppetManifestParser(const langType language) {
  ...
  addLanguageTagMultiTableRegex(language, "main",
                                "^@?[a-zA-Z][a-zA-Z0-9:_]*[ \t\n]*\\{", "", "",
                                "{tenter=resourceBlock}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^class[ \t\n]+", "", "",
                                "{tenter=classStart}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^define[ \t\n]+", "", "",
                                "{tenter=defineStart}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^case[ \t\n]+", "", "",
                                "{tenter=caseStart}", NULL);
  addLanguageTagMultiTableRegex(language, "main",
                                "^(if|elsif|else|unless)[ \t\n]+", "", "",
                                "{tenter=ifStart}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^node[ \t\n]+", "", "",
  ...
  addLanguageTagMultiTableRegex(language, "separator", "^[a-zA-Z0-9]", "", "",
                                "", NULL);
  addLanguageTagMultiTableRegex(language, "separator", "^", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "any", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "ignoreWhiteSpace", "^[ \t\n]+", "",
                                "", "", NULL);
  addLanguageTagMultiTableRegex(language, "end", "^", "", "", "{tleave}", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "blockStart",
                                "^@?[a-zA-Z][a-zA-Z0-9:_]*[ \t\n]*\\{", "", "",
                                "{tenter=resourceBlock}", NULL);
  addLanguageTagMultiTableRegex(language, "blockStart", "^class[ \t\n]+", "",
                                "", "{tenter=classStart}", NULL);
  addLanguageTagMultiTableRegex(language, "blockStart", "^define[ \t\n]+", "",
                                "", "{tenter=defineStart}", NULL);
  addLanguageTagMultiTableRegex(language, "blockStart", "^case[ \t\n]+", "", "",
                                "{tenter=caseStart}", NULL);
  addLanguageTagMultiTableRegex(language, "blockStart",
                                "^(if|elsif|else|unless)[ \t\n]+", "", "",
                                "{tenter=ifStart}", NULL);
  addLanguageTagMultiTableRegex(language, "blockStart", "^node[ \t\n]+", "", "",
                                "{tenter=nodeStart}", NULL);
  addLanguageTagMultiTableRegex(language, "blockStart", "^\\$", "", "",
                                "{tenter=var}", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "blockHead", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "block",
                                "^@?[a-zA-Z][a-zA-Z0-9:_]*[ \t\n]*\\{", "", "",
                                "{tenter=resourceBlock}", NULL);
  addLanguageTagMultiTableRegex(language, "block", "^class[ \t\n]+", "", "",
                                "{tenter=classStart}", NULL);
  addLanguageTagMultiTableRegex(language, "block", "^define[ \t\n]+", "", "",
                                "{tenter=defineStart}", NULL);
  addLanguageTagMultiTableRegex(language, "block", "^case[ \t\n]+", "", "",
                                "{tenter=caseStart}", NULL);
  addLanguageTagMultiTableRegex(language, "block",
                                "^(if|elsif|else|unless)[ \t\n]+", "", "",
                                "{tenter=ifStart}", NULL);
  addLanguageTagMultiTableRegex(language, "block", "^node[ \t\n]+", "", "",
                                "{tenter=nodeStart}", NULL);
  addLanguageTagMultiTableRegex(language, "block", "^\\$", "", "",
                                "{tenter=var}", NULL);
  addLanguageTagMultiTableRegex(language, "block", "^<<?\\|", "", "",
  ...
  addLanguageTagMultiTableRegex(language, "block", "^:", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "block", "^/\\*", "", "",
                                "{tenter=comment_multiline}", NULL);
  addLanguageTagMultiTableRegex(language, "block", "^\\#", "", "",
                                "{tenter=comment_oneline}", NULL);
  ...
  addLanguageTagMultiTableRegex(
      language, "classStart", "^(::[a-z][_a-zA-Z0-9:]*)", "\\1", "c",
      "{tenter=blockHead,endWithPop}{scope=push}", NULL);
  addLanguageTagMultiTableRegex(
      language, "classStart", "^([a-z][_a-zA-Z0-9:]*)", "\\1", "c",
      "{tenter=blockHead,endWithPop}{scope=push}", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "resourceBlock", "^\\}", "", "",
                                "{tleave}", NULL);
  addLanguageTagMultiTableRegex(language, "resourceBlock", "^'", "", "",
                                "{tenter=resourceName}{_advanceTo=0start}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "resourceBlock", "^\"", "", "",
                                "{tenter=resourceName}{_advanceTo=0start}",
                                NULL);
  ...
  addLanguageTagMultiTableRegex(language, "skipBlock", "^\\}", "", "",
                                "{tleave}", NULL);
  addLanguageTagMultiTableRegex(language, "skipBlock", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "skipArray", "^\\]", "", "",
                                "{tleave}", NULL);
  addLanguageTagMultiTableRegex(language, "skipArray", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "skipArgs", "^\\)", "", "",
                                "{tleave}", NULL);
  addLanguageTagMultiTableRegex(language, "skipArgs", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "var",
                                "^(::[a-zA-Z0-9_:]+)[ \t\n]*=", "\\1", "v",
                                "{tenter=varexpr,end}", NULL);
  addLanguageTagMultiTableRegex(language, "var",
                                "^([a-zA-Z_][a-zA-Z0-9_:]*)[ \t\n]*=", "\\1",
                                "v", "{tenter=varexpr,end}{scope=ref}", NULL);
  addLanguageTagMultiTableRegex(language, "defineStart", "^/\\*", "", "",
                                "{tenter=comment_multiline}", NULL);
  addLanguageTagMultiTableRegex(language, "defineStart", "^\\#", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(
      language, "defineStart", "^([a-z][_a-zA-Z0-9:]*)[ \n\t]*\\(", "\\1", "d",
      "{tenter=skipArgs,blockHeadPopAtLast}{scope=push}", NULL);
  addLanguageTagMultiTableRegex(language, "defineStart",
                                "^([a-z][_a-zA-Z0-9:]*)[ \n\t]*\\{", "\\1", "d",
                                "{tenter=block,endWithPop}{scope=push}", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "caseStart", "^}", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "caseStart", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "ifStart", "^\\{", "", "",
                                "{tenter=block,end}", NULL);
  addLanguageTagMultiTableRegex(language, "ifStart", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "nodeStart", "^[ \t\n]+", "", "", "",
                                NULL);
  addLanguageTagMultiTableRegex(language, "nodeStart", "^'([^']+)'", "\\1", "n",
                                "", NULL);
  addLanguageTagMultiTableRegex(language, "nodeStart", "^\"([^\"]+)\"", "\\1",
                                "n", "", NULL);
  addLanguageTagMultiTableRegex(language, "nodeStart", "^\\{", "", "",
                                "{tenter=block,end}", NULL);
  addLanguageTagMultiTableRegex(language, "nodeStart", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "comment_oneline", "^.", "", "", "",
                                NULL);
  addLanguageTagMultiTableRegex(language, "resourceName", "^'([^']+)'", "\\1",
                                "r", "{tenter=resourceBody,end}{scope=push}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "resourceName", "^\"([^\"]+)\"",
                                "\\1", "r",
                                "{tenter=resourceBody,end}{scope=push}", NULL);
  addLanguageTagMultiTableRegex(language, "resourceName", "^", "", "",
                                "{tquit}", NULL);
  ...
  addLanguageTagMultiTableRegex(
      language, "varexpr", "^\\$[a-zA-Z:][0-9a-zA-Z\"]*", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "varexpr",
                                "^[0-9]+(\\.[0-9]+(e([+-][0-9]+)))?", "", "",
                                "", NULL);
  addLanguageTagMultiTableRegex(language, "varexpr",
                                "^[a-zA-Z0-9:][0-9a-zA-Z:]*", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "varexpr", "^[ \t]", "", "", "",
                                NULL);
  addLanguageTagMultiTableRegex(language, "varexpr", "^\n", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "varexpr", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "caseBlock", "^.", "", "", "", NULL);
}

extern parserDefinition *PuppetManifestParser(void) {
  static const char *const extensions[] = {"pp", NULL};
