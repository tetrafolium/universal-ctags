/*
 * Generated by ./misc/optlib2c from optlib/markdown.ctags, Don't edit this
 * manually.
 */
#include "field.h"
#include "general.h"
...
static void initializeMarkdownParser(const langType language) {
  ...
  addLanguageTagMultiTableRegex(
      language, "main", "^([^\n]+)[\n]=+[\n]", "\\1", "c",
      "{_field=sectionMarker:=}{scope=push}{tenter=chapter}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main", "^([^\n]+)[\n]-+[\n]", "\\1", "s",
      "{_field=sectionMarker:-}{scope=push}{tenter=section}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main", "^[ \t]*````*([a-zA-Z0-9][-#+a-zA-Z0-9]*)?[^`\n]*[\n]",
  ...
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^#[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1", "c",
      "{_field=sectionMarker:##}{scope=push}{tenter=chapter,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^#[ \t]+([^\n]+)[\n]*", "\\1", "c",
      "{_field=sectionMarker:#}{scope=push}{tenter=chapter,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^##[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1", "s",
      "{_field=sectionMarker:##}{scope=push}{tenter=section,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^##[ \t]+([^\n]+)[\n]*", "\\1", "s",
      "{_field=sectionMarker:#}{scope=push}{tenter=section,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^###[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1", "S",
      "{_field=sectionMarker:##}{scope=push}{tenter=subsection,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^###[ \t]+([^\n]+)[\n]*", "\\1", "S",
      "{_field=sectionMarker:#}{scope=push}{tenter=subsection,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^####[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1", "t",
      "{_field=sectionMarker:##}{scope=push}{tenter=subsubsection,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^####[ \t]+([^\n]+)[\n]*", "\\1", "t",
      "{_field=sectionMarker:#}{scope=push}{tenter=subsubsection,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^#####[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1", "T",
      "{_field=sectionMarker:##}{scope=push}{tenter=l4subsection,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^#####[ \t]+([^\n]+)[\n]*", "\\1", "T",
      "{_field=sectionMarker:#}{scope=push}{tenter=l4subsection,main}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^######[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "u", "{_field=sectionMarker:##}{scope=push}{tenter=l5subsection,main}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "main_sharp", "^######[ \t]+([^\n]+)[\n]*", "\\1", "u",
      "{_field=sectionMarker:#}{scope=push}{tenter=l5subsection,main}", NULL);
  addLanguageTagMultiTableRegex(language, "main_sharp", "^.", "", "",
                                "{tjump=main}", NULL);
  addLanguageTagMultiTableRegex(language, "chapter", "^#", "", "",
                                "{_advanceTo=0start}{tjump=chapter_sharp}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "chapter", "^([\t ]*)[\n]+", "", "",
                                "", NULL);
  addLanguageTagMultiTableRegex(
  ...
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^##[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1", "s",
      "{_field=sectionMarker:##}{scope=push}{tenter=section,chapter}", NULL);
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^##[ \t]+([^\n]+)[\n]*", "\\1", "s",
      "{_field=sectionMarker:#}{scope=push}{tenter=section,chapter}", NULL);
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^###[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "S", "{_field=sectionMarker:##}{scope=push}{tenter=subsection,chapter}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^###[ \t]+([^\n]+)[\n]*", "\\1", "S",
      "{_field=sectionMarker:#}{scope=push}{tenter=subsection,chapter}", NULL);
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^####[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "t",
      "{_field=sectionMarker:##}{scope=push}{tenter=subsubsection,chapter}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^####[ \t]+([^\n]+)[\n]*", "\\1", "t",
      "{_field=sectionMarker:#}{scope=push}{tenter=subsubsection,chapter}",
  ...
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^#####[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "T", "{_field=sectionMarker:##}{scope=push}{tenter=l4subsection,chapter}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^#####[ \t]+([^\n]+)[\n]*", "\\1", "T",
      "{_field=sectionMarker:#}{scope=push}{tenter=l4subsection,chapter}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^######[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "u", "{_field=sectionMarker:##}{scope=push}{tenter=l5subsection,chapter}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "chapter_sharp", "^######[ \t]+([^\n]+)[\n]*", "\\1", "u",
      "{_field=sectionMarker:#}{scope=push}{tenter=l5subsection,chapter}",
      NULL);
  addLanguageTagMultiTableRegex(language, "chapter_sharp", "^.", "", "",
                                "{tjump=chapter}", NULL);
  addLanguageTagMultiTableRegex(language, "section", "^#", "", "",
                                "{_advanceTo=0start}{tjump=section_sharp}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "section", "^([\t ]*)[\n]+", "", "",
                                "", NULL);
  addLanguageTagMultiTableRegex(language, "section", "^([^\n]+)[\n](=+|-+)[\n]",
  ...
  addLanguageTagMultiTableRegex(language, "section_sharp",
                                ...
                                "{scope=pop}{tleave}{_advanceTo=0start}", NULL);
  addLanguageTagMultiTableRegex(
      language, "section_sharp", "^###[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "S", "{_field=sectionMarker:##}{scope=push}{tenter=subsection,section}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "section_sharp", "^###[ \t]+([^\n]+)[\n]*", "\\1", "S",
      "{_field=sectionMarker:#}{scope=push}{tenter=subsection,section}", NULL);
  addLanguageTagMultiTableRegex(
      language, "section_sharp", "^####[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "t",
      "{_field=sectionMarker:##}{scope=push}{tenter=subsubsection,section}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "section_sharp", "^####[ \t]+([^\n]+)[\n]*", "\\1", "t",
      "{_field=sectionMarker:#}{scope=push}{tenter=subsubsection,section}",
  ...
  addLanguageTagMultiTableRegex(
      language, "section_sharp", "^#####[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "T", "{_field=sectionMarker:##}{scope=push}{tenter=l4subsection,section}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "section_sharp", "^#####[ \t]+([^\n]+)[\n]*", "\\1", "T",
      "{_field=sectionMarker:#}{scope=push}{tenter=l4subsection,section}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "section_sharp", "^######[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "u", "{_field=sectionMarker:##}{scope=push}{tenter=l5subsection,section}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "section_sharp", "^######[ \t]+([^\n]+)[\n]*", "\\1", "u",
      "{_field=sectionMarker:#}{scope=push}{tenter=l5subsection,section}",
      NULL);
  addLanguageTagMultiTableRegex(language, "section_sharp", "^.", "", "",
                                "{tjump=section}", NULL);
  addLanguageTagMultiTableRegex(language, "subsection", "^#", "", "",
                                "{_advanceTo=0start}{tjump=subsection_sharp}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "subsection", "^([\t ]*)[\n]+", "",
                                "", "", NULL);
  addLanguageTagMultiTableRegex(language, "subsection",
  ...
  addLanguageTagMultiTableRegex(language, "subsection", "^[^\n]*", "", "",
                                "{tquit}", NULL);
  addLanguageTagMultiTableRegex(
      language, "subsection_sharp", "^#{1,3}[ \t]+([^\n]+)", "", "",
      "{scope=pop}{tleave}{_advanceTo=0start,subsection}", NULL);
  addLanguageTagMultiTableRegex(
      language, "subsection_sharp", "^####[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
      "t",
      "{_field=sectionMarker:##}{scope=push}{tenter=subsubsection,subsection}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "subsection_sharp", "^####[ \t]+([^\n]+)[\n]*", "\\1", "t",
      "{_field=sectionMarker:#}{scope=push}{tenter=subsubsection,subsection}",
  ...
  addLanguageTagMultiTableRegex(
      language, "subsection_sharp", "^#####[ \t]+([^\n]+)([ \t]+#+)[\n]*",
      "\\1", "T",
      "{_field=sectionMarker:##}{scope=push}{tenter=l4subsection,subsection}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "subsection_sharp", "^#####[ \t]+([^\n]+)[\n]*", "\\1", "T",
      "{_field=sectionMarker:#}{scope=push}{tenter=l4subsection,subsection}",
  ...
  addLanguageTagMultiTableRegex(
      language, "subsection_sharp", "^######[ \t]+([^\n]+)([ \t]+#+)[\n]*",
      "\\1", "u",
      "{_field=sectionMarker:##}{scope=push}{tenter=l5subsection,subsection}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "subsection_sharp", "^######[ \t]+([^\n]+)[\n]*", "\\1", "u",
      "{_field=sectionMarker:#}{scope=push}{tenter=l5subsection,subsection}",
  ...
  addLanguageTagMultiTableRegex(language, "subsubsection_sharp",
                                "^#####[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
                                "T",
                                "{_field=sectionMarker:##}{scope=push}{tenter="
                                "l4subsection,subsubsection}",
                                NULL);
  addLanguageTagMultiTableRegex(
      language, "subsubsection_sharp", "^#####[ \t]+([^\n]+)[\n]*", "\\1", "T",
      "{_field=sectionMarker:#}{scope=push}{tenter=l4subsection,subsubsection}",
      NULL);
  addLanguageTagMultiTableRegex(language, "subsubsection_sharp",
                                "^######[ \t]+([^\n]+)([ \t]+#+)[\n]*", "\\1",
                                "u",
                                "{_field=sectionMarker:##}{scope=push}{tenter="
                                "l5subsection,subsubsection}",
                                NULL);
  addLanguageTagMultiTableRegex(
      language, "subsubsection_sharp", "^######[ \t]+([^\n]+)[\n]*", "\\1", "u",
      "{_field=sectionMarker:#}{scope=push}{tenter=l5subsection,subsubsection}",
      NULL);
  addLanguageTagMultiTableRegex(language, "subsubsection_sharp", "^.", "", "",
                                "{tjump=subsubsection}", NULL);
  addLanguageTagMultiTableRegex(language, "l4subsection", "^#", "", "",
                                "{_advanceTo=0start}{tjump=l4subsection_sharp}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "l4subsection", "^([\t ]*)[\n]+", "",
                                "", "", NULL);
  addLanguageTagMultiTableRegex(language, "l4subsection",
  ...
  addLanguageTagMultiTableRegex(language, "l4subsection_sharp",
                                ...
                                "{scope=pop}{tleave}{_advanceTo=0start}", NULL);
  addLanguageTagMultiTableRegex(
      language, "l4subsection_sharp", "^######[ \t]+([^\n]+)([ \t]+#+)[\n]*",
      "\\1", "u",
      "{_field=sectionMarker:##}{scope=push}{tenter=l5subsection,l4subsection}",
      NULL);
  addLanguageTagMultiTableRegex(
      language, "l4subsection_sharp", "^######[ \t]+([^\n]+)[\n]*", "\\1", "u",
      "{_field=sectionMarker:#}{scope=push}{tenter=l5subsection,l4subsection}",
  ...
  addLanguageTagMultiTableRegex(language, "l5subsection", "^#", "", "",
                                "{_advanceTo=0start}{tjump=l5subsection_sharp}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "l5subsection", "^([\t ]*)[\n]+", "",
                                "", "", NULL);
  addLanguageTagMultiTableRegex(language, "l5subsection",
  ...
  addLanguageTagMultiTableRegex(language, "rest", "^[^\n]*", "", "", "{tquit}",
                                NULL);
  addLanguageTagMultiTableRegex(
      language, "code", "^[ \t]*````*([a-zA-Z0-9][-#+a-zA-Z0-9]*)?[^`\n]*[\n]",
      "", "", "{tenter=codeblockBacktick}{_guest=\\1,0end,}", NULL);
  addLanguageTagMultiTableRegex(
      language, "code", "^[ \t]*~~~~*([a-zA-Z0-9][-#+a-zA-Z0-9]*)?[^~\n]*[\n]",
      "", "", "{tenter=codeblockTildes}{_guest=\\1,0end,}", NULL);
