/*
 * Generated by ./misc/optlib2c from optlib/systemtap.ctags, Don't edit this
 * manually.
 */
#include "field.h"
#include "general.h"
...
static void initializeSystemTapParser(const langType language) {
  ...
  addLanguageTagMultiTableRegex(language, "main", "^[^#/'\"pfg@%]+", "", "", "",
                                NULL);
  addLanguageTagMultiTableRegex(language, "main", "^probe[[:space:]]+", "", "",
                                "{tenter=probe}", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "main", "^//", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^@define[[:space:]]+", "",
                                "", "{tenter=macro}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^function[[:space:]]+", "",
                                "", "{tenter=func}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^global[[:space:]]+", "", "",
                                "{tenter=vars}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^%[\\{(]", "", "",
                                "{tenter=cfuncStmt}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "arraysize", "^[^]/#]+", "", "", "",
                                NULL);
  addLanguageTagMultiTableRegex(language, "arraysize", "^]", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "arraysize", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "stmtend", "^", "", "",
                                "{tleave}{scope=pop}", NULL);
  addLanguageTagMultiTableRegex(
      language, "probe",
      "^([[:alpha:]_][[:alnum:]_.]*)[[:space:]]*\\+?=[[:space:]]*", "\\1", "p",
  ...
  addLanguageTagMultiTableRegex(language, "probeBody", "^//", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "probeBody", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "probeStmt", "^//", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "probeStmt", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "func",
                                "^([[:alpha:]_][[:alnum:]_]*)(:[[:alpha:]_][[:"
                                "alnum:]_]*)?[[:space:]]*\\(",
                                "\\1", "f",
                                "{tenter=funcSig,funcBody}{scope=push}", NULL);
  addLanguageTagMultiTableRegex(language, "funcSig", "^[^)/]+", "", "", "",
                                NULL);
  addLanguageTagMultiTableRegex(language, "funcSig", "^\\)(:[0-9]+)?", "", "",
                                "{tleave}", NULL);
  addLanguageTagMultiTableRegex(language, "funcSig", "^\\#", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "funcSig", "^/\\*", "", "",
  ...
  addLanguageTagMultiTableRegex(language, "funcSig", "^//", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "funcSig", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "funcBody", "^//", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "funcBody", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "funcStmt", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "cfuncStmt", "^%[\\{(]", "", "",
                                "{tenter=cfuncStmt}", NULL);
  addLanguageTagMultiTableRegex(language, "cfuncStmt", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(
      language, "vars", "^([[:alpha:]_][[:alnum:]_]*)%?", "\\1", "v", "", NULL);
  addLanguageTagMultiTableRegex(language, "vars", "^[\n]", "", "", "{tleave}",
                                NULL);
  addLanguageTagMultiTableRegex(language, "vars", "^,[[:space:]]*", "", "",
                                "{tjump=vars}", NULL);
  addLanguageTagMultiTableRegex(language, "vars", "^\\#", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "vars", "^/\\*", "", "",
  ...
  addLanguageTagMultiTableRegex(language, "vars", "^.", "", "", "", NULL);
  addLanguageTagMultiTableRegex(
      language, "macro", "^([[:alpha:]_][[:alnum:]_]*)[[:space:]]*\\(", "\\1",
      "m", "{tenter=macroSig,macroBody}{scope=push}", NULL);
  addLanguageTagMultiTableRegex(
      language, "macro", "^([[:alpha:]_][[:alnum:]_]*)[[:space:]]*", "\\1", "m",
      "{tenter=macroBody,stmtend}{scope=push}", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "macroSig", "^//", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "macroSig", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "macroBody", "^//", "", "",
                                "{tenter=comment_oneline}", NULL);
  addLanguageTagMultiTableRegex(language, "macroBody", "^.", "", "", "", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "macroStmt", "^.", "", "", "", NULL);
...
extern parserDefinition *SystemTapParser(void) {
  static const char *const extensions[] = {"stp", "stpm", NULL};

  static const char *const aliases[] = {".stap", NULL};
