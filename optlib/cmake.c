/*
 * Generated by ./misc/optlib2c from optlib/cmake.ctags, Don't edit this
 * manually.
 */
#include "field.h"
#include "general.h"
...
static void initializeCMakeParser(const langType language) {
  ...
  addLanguageTagMultiTableRegex(language, "main", "^set[ \t]*\\(", "", "",
                                "{icase}{tenter=variable}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^function[ \t]*\\(", "", "",
                                "{icase}{tenter=function}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^macro[ \t]*\\(", "", "",
                                "{icase}{tenter=macro}", NULL);
  addLanguageTagMultiTableRegex(
      language, "main", "^add_(custom_target|executable|library)[ \t]*\\(", "",
      "", "{icase}{tenter=target}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^option[ \t]*\\(", "", "",
                                "{icase}{tenter=option}", NULL);
  addLanguageTagMultiTableRegex(language, "main", "^project[ \t]*\\(", "", "",
  ...
  addLanguageTagMultiTableRegex(language, "variable", "^#", "", "",
                                "{tenter=commentBegin}", NULL);
  addLanguageTagMultiTableRegex(language, "variable", "^([A-Za-z0-9_.-]+)(#)",
                                "\\1", "v", "{tleave}{_advanceTo=2start}",
                                NULL);
  ...
  addLanguageTagMultiTableRegex(language, "variableScoped", "^#", "", "",
                                "{tenter=commentBegin}", NULL);
  addLanguageTagMultiTableRegex(
      language, "function", "^([A-Za-z_][A-Za-z0-9_]*)([# \t\n\\)])", "\\1",
      "f", "{_advanceTo=2start}{tjump=inFunction}{scope=push}", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "macro", "^#", "", "",
                                "{tenter=commentBegin}", NULL);
  addLanguageTagMultiTableRegex(language, "macro",
                                "^([A-Za-z_][A-Za-z0-9_]*)(#)", "\\1", "m",
                                "{tleave}{_advanceTo=2start}", NULL);
  ...
  addLanguageTagMultiTableRegex(language, "target", "^#", "", "",
                                "{tenter=commentBegin}", NULL);
  addLanguageTagMultiTableRegex(language, "target", "^([A-Za-z0-9_.-]+)(#)",
                                "\\1", "t", "{tleave}{_advanceTo=2start}",
                                NULL);
  ...
  addLanguageTagMultiTableRegex(language, "option", "^#", "", "",
                                "{tenter=commentBegin}", NULL);
  addLanguageTagMultiTableRegex(language, "option", "^([A-Za-z0-9_.-]+)(#)",
                                "\\1", "D", "{tleave}{_advanceTo=2start}",
                                NULL);
  ...
  addLanguageTagMultiTableRegex(language, "inFunction", "^#", "", "",
                                "{tenter=commentBegin}", NULL);
  addLanguageTagMultiTableRegex(language, "inFunction", "^set[ \t]*\\(", "", "",
                                "{icase}{tenter=variableScoped}", NULL);
  addLanguageTagMultiTableRegex(language, "inFunction", "^function[ \t]*\\(",
                                "", "", "{icase}{tenter=function}", NULL);
  addLanguageTagMultiTableRegex(language, "inFunction", "^macro[ \t]*\\(", "",
                                "", "{icase}{tenter=macro}", NULL);
  addLanguageTagMultiTableRegex(language, "inFunction",
                                "^endfunction[ \t]*\\([^)]*\\)", "", "",
  ...
  addLanguageTagMultiTableRegex(
      ...
      "{icase}{tenter=target}", NULL);
  addLanguageTagMultiTableRegex(language, "inFunction", "^option[ \t]*\\(", "",
                                "", "{icase}{tenter=option}", NULL);
  addLanguageTagMultiTableRegex(language, "inFunction", "^[^ \t\n]+[ \t\n]*",
                                "", "", "", NULL);
  addLanguageTagMultiTableRegex(language, "inFunction", "^[ \t\n]+", "", "", "",
  ...
  addLanguageTagMultiTableRegex(language, "inVariable",
                                "^([A-Za-z0-9_.-]+)[ \t\n\\)]+", "\\1", "v",
                                "{tleave}{scope=ref}", NULL);
  addLanguageTagMultiTableRegex(language, "inVariable", "^([A-Za-z0-9_.-]+)(#)",
                                "\\1", "v",
                                "{tleave}{scope=ref}{_advanceTo=2start}", NULL);
}

extern parserDefinition *CMakeParser(void) {
  static const char *const extensions[] = {"cmake", NULL};

  static const char *const aliases[] = {NULL};

  static const char *const patterns[] = {"CMakeLists.txt", NULL};
