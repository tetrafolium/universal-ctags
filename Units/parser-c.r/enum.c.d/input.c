enum E1 { E1_member1 = 1, E1_member2, E1_member3 };
...
//
// It's true that the definition for function2 *could* be in some other
// compilation unit and since the enum is technically an int, it might even work
// at linker level.
//
// However, it's ugly and complicates ctags parsing quite a lot.
// So for now I deliberately choose to not support it. If you find a piece of
// code that needs it, drop me a mail at <s dot stefanek at gmail dot com> :P
