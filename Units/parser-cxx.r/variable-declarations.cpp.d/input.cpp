...
// All the m*, l* and v* are valid variable declarations. The n* are NOT valid
// declarations.
...
#define SIZE 25
  ...
  auto l32 = new std::basic_string<wchar_t, std::char_traits<wchar_t>,
...
template <typename X> X func(X p1) { return p1 + 1; }
