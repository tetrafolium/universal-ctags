...
#define DECLARE_FUNCTION_4(Ret, Class, Method, ...)                            \
  Ret Class##__##Method(Class *this, ##__VA_ARGS__)
#define DECLARE_FUNCTION_4_BEGIN(...)                                          \
  { /*not really this, but this is what ctags should see*/
#define DECLARE_FUNCTION_4_END(...)                                            \
  } /*not really this, but this is what ctags should see*/
