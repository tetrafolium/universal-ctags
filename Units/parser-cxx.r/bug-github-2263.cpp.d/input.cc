...
template <class T, typename T3 = C0<C0<C0<C0<const T>>>>, class S = int>
class C4x1 {
  T3 t3;
  S s;
...
template <class T, typename T3 = C0<C0<C0<C0<const T>>>>, class S = C0<const T>>
class C4x2 {
  T3 t3;
  S s;
