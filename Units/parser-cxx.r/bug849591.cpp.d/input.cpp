...
*/
void MainClass<ParamClass1 &, ParamClass2>::Foo() { exit(0); };
/*
Generates erroneous tag
ParamClass1	test.cpp	/^void MainClass< ParamClass1&,
ParamClass2>::Foo()$/;"	v
...
Foo	test.cpp	/^void MainClass< const ParamClass1&,
ParamClass2>::Foo()$/;"	f	class:ParamClass2 ParamClass1	test.cpp
/^void MainClass< ParamClass1&, ParamClass2>::Foo()$/;"	v
...
aramClass1	test.cpp	/^void MainClass<ParamClass1&,
ParamClass2>::Foo()$/;"	v
