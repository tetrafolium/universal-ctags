...
static inline int *f06() { return 0; }
...
std::vector<std::string> *f08() { return 0; }

auto p09() -> std::vector<std::string> *** { return 0; }
...
auto f11() -> int (*)(int) { return 0; }

template <typename A> std::vector<A> *f13() { return 0; }

template <typename A> auto f14() -> std::vector<A> * { return 0; }
