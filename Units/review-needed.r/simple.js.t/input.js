...
function validFunctionThree(a, b) { var innerThree = function(a, b) {} }
...
// pseudo-module setup
testlib = {} testlib.core = {} testlib.extras = {}
...
var invalidInnerFunction = function(a, b) {}
    ...
    testlib.extras.ValidClassOne = function(a, b) { this.a = a; }
...
for (var i = 0; i < my_global_var4.length; i++) {
  ...
  my_global_var4[i].onchange =
      function() { alert(this.value + " == " + originalvalue); }
}
