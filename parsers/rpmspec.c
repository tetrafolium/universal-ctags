...
static void findRpmSpecTags (void)
{
    ...
    rpmSpecCtx.macro = (struct macro_cb_data) {
        .kindex = K_MACOR, .rindex = ROLE_DEFINITION_INDEX
    };
    rpmSpecCtx.global = (struct macro_cb_data) {
        K_GLOBAL, ROLE_DEFINITION_INDEX
    };
    rpmSpecCtx.undef = (struct macro_cb_data) {
        K_MACOR,  R_MACRO_UNDEF
    };
