...
static cKind cTagKindFull (const tagType type, const bool with_assert)
{
    ...
    default:
        if (with_assert) Assert ("Bad C tag type" == NULL);
        break;
    }
    return result;
}
...
static javaKind javaTagKindFull (const tagType type, bool with_assert)
{
    ...
    default:
        if (with_assert) Assert ("Bad Java tag type" == NULL);
        break;
    }
    return result;
}
...
static dKind dTagKindFull (const tagType type, bool with_assert)
{
    ...
    default:
        if (with_assert) Assert ("Bad D tag type" == NULL);
        break;
    }
    return result;
}
...
static veraKind veraTagKindFull (const tagType type, bool with_assert) {
    ...
    default:
        if (with_assert) Assert ("Bad Vera tag type" == NULL);
        break;
    }
    return result;
}
        ...
        default:
            if (cppIsident1 (c))
            {
                ...
                case KEYWORD_THROW:
                    ...
                    break;
                case KEYWORD_IF:
                    if (isInputLanguage (Lang_d)) skipParens ();
                    break;
                case KEYWORD_TRY:
                    break;
