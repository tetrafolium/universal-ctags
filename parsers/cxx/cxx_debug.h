...
#define CXX_DEBUG_PRINT(_szFormat, ...) TRACE_PRINT(_szFormat, ##__VA_ARGS__)
...
#define CXX_DEBUG_ENTER()                                                      \
  do {                                                                         \
  } while (0)
#define CXX_DEBUG_LEAVE()                                                      \
  do {                                                                         \
  } while (0)
...
#define CXX_DEBUG_TOKEN(T)                                                     \
  do {                                                                         \
  } while (0)
#define CXX_DEBUG_CHAIN(T)                                                     \
  do {                                                                         \
  } while (0)
