...
CXXToken *cxxTokenChainLastPossiblyNestedTokenOfType(
    CXXTokenChain *tc, unsigned int uTokenTypes, CXXTokenChain **ppParentChain);
...
CXXToken *cxxTokenChainExtractRangeFilterTypeName(CXXToken *from, CXXToken *to);
...
CXXToken *cxxTokenChainNextIdentifier(CXXToken *from, const char *szIdentifier);
