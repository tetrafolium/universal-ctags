...
bool cxxParserParseEnum(void) {
  ...
  /*
      Spec is:
              ...
              enum-key	-	one of enum, enum class(since C++11), or enum
     struct(since C++11) attr(C++11)	-	optional sequence of any number
     of attributes identifier	-	the name of the enumeration that's being
     ...
     ignored) enumerator-list	-	comma-separated list of enumerator
     definitions, each of which is either simply an identifier, which becomes
     the name of the enumerator, or an identifier with an initializer:
     identifier = constexpr. In either case, the identifier can be directly
     followed by an optional attribute specifier sequence. (since C++17)
  */
...
static bool cxxParserParseClassStructOrUnionInternal(CXXKeyword eKeyword,
  ...
  /*
     ...
     class)
              member-specification	-	list of access specifiers, member object
     and member function declarations and definitions (see below)
  */
