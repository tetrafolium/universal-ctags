 ...
 *   FUNCTION PROTOTYPES
 */
static void antFindTagsUnderProject(xmlNode *node, const char *xpath,
                                    const struct sTagXpathRecurSpec *spec,
                                    xmlXPathContext *ctx, void *userData);
static void antFindTagsUnderTask(xmlNode *node, const char *xpath,
                                 const struct sTagXpathRecurSpec *spec,
                                 xmlXPathContext *ctx, void *userData);
static void makeTagForProjectName(xmlNode *node, const char *xpath,
                                  const struct sTagXpathMakeTagSpec *spec,
                                  struct sTagEntryInfo *tag, void *userData);
static void makeTagForTargetName(xmlNode *node, const char *xpath,
                                 const struct sTagXpathMakeTagSpec *spec,
                                 struct sTagEntryInfo *tag, void *userData);
...
static kindDefinition AntKinds[] = {
    ...
    {true, 'i', "antfile", "antfiles", .referenceOnly = true,
     ATTACH_ROLES(AntAntfileRoles)},
};
...
static tagXpathTable antXpathProjectTable[] = {
    ...
    {"property/@name",
     ...
     {.makeTagSpec = {K_PROPERTY, ROLE_DEFINITION_INDEX, makeTagWithScope}}},
    {"import/@file",
     LXPATH_TABLE_DO_MAKE,
     {.makeTagSpec = {K_IMPORT, R_IMPORT_GENERIC, makeTagWithScope}}},
};
...
static tagXpathTable antXpathTargetNameTable[] = {
    {"@name",
     LXPATH_TABLE_DO_MAKE,
     {.makeTagSpec = {K_TARGET, ROLE_DEFINITION_INDEX, makeTagForTargetName}}},
};
...
static void
antFindTagsUnderProject(xmlNode *node, const char *xpath CTAGS_ATTR_UNUSED,
...
static void
makeTagForProjectName(xmlNode *node CTAGS_ATTR_UNUSED,
                      const char *xpath CTAGS_ATTR_UNUSED,
...
static void
makeTagForTargetName(xmlNode *node CTAGS_ATTR_UNUSED,
                     const char *xpath CTAGS_ATTR_UNUSED,
                     const struct sTagXpathMakeTagSpec *spec CTAGS_ATTR_UNUSED,
                     struct sTagEntryInfo *tag, void *userData) {
  int *corkIndex = (int *)userData;
