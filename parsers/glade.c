 ...
 *
 *   This module contains functions for generating tags for diff files (based on
 * Sh parser).
 */
...
static kindDefinition GladeKinds[] = {
    ...
    {true, 'c', "class", "classes", .referenceOnly = true,
     ATTACH_ROLES(GladeClassRoles)},
    {true, 'h', "handler", "handlers", .referenceOnly = true,
     ATTACH_ROLES(GladeHandlerRoles)},
};
...
extern parserDefinition *GladeParser(void) {
