...
static void tillToken(vString *const ident CTAGS_ATTR_UNUSED, ocaToken what,
                      ocaToken whatNext CTAGS_ATTR_UNUSED) {
  if (what == waitedToken)
    toDoNext = comeAfter;
...
static void ignoreToken(vString *const ident CTAGS_ATTR_UNUSED,
                        ocaToken what CTAGS_ATTR_UNUSED,
                        ocaToken whatNext CTAGS_ATTR_UNUSED) {
  toDoNext = comeAfter;
}
...
static void requestStrongPoping(void) { needStrongPoping = true; }
...
static void mayRedeclare(vString *const ident, ocaToken what,
  ...
  case OcaKEYWORD_object:
    ...
    pushContext(ContextStrong, ContextClass, &localScope, NULL);
    needStrongPoping = false;
    toDoNext = &globalScope;
    break;
