...
typedef struct sParserObject {
  ...
  unsigned int dontEmit : 1;         /* run but don't emit tags.
                                                                    This parser was
                                        disabled but a subparser on         this parser makes
                                        this parser run (to drive         the subparser). */
  ...
  langType pretendingAsLanguage; /* OLDLANG in --_pretend-<NEWLANG>=<OLDLANG>
                                                                    is set here
                                    if this parser is NEWLANG. LANG_IGNORE is
                                    set if no pretending. */
  langType
      pretendedAsLanguage; /* NEWLANG in --_pretend-<NEWLANG>=<OLDLANG>
                                                              is set here if
                              this parser is OLDLANG. LANG_IGNORE is set if no
                              being pretended. */
