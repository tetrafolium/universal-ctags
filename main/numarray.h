...
declNumArray(char, Char, char) declNumArray(uchar, Uchar, unsigned char)
    declNumArray(int, Int, int) declNumArray(uint, Uint, unsigned int)
        declNumArray(long, Long, long) declNumArray(ulong, Ulong, unsigned long)
