...
struct sTagEntryInfo {
  ...
  unsigned int
      truncateLineAfterTag : 1; /* truncate tag line at end of tag name? */
  ...
  unsigned int
      skipAutoFQEmission : 1;   /* If a parser makes a fq tag for the
                                                                           current
                                   tag by itself, set this. */
  ...
  uint8_t *
      extraDynamic; /* Dynamically allocated but freed by per parser TrashBox */
