...
static void stringCat(vString *const string, const char *const s,
                      const size_t length) {
...
extern void vStringNCat(vString *const string, const vString *const s,
                        const size_t length) {
...
extern void vStringNCatSUnsafe(vString *const string, const char *const s,
                               const size_t length) {
...
extern void vStringNCopy(vString *const string, const vString *const s,
                         const size_t length) {
  vStringClear(string);
...
extern void vStringCatSWithEscapingAsPattern(vString *output,
                                             const char *input) {
  while (*input) {
    switch (*input) {
    case '\\':
