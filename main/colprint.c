...
static struct colprintHeaderColumn *colprintHeaderColumnNew(const char *spec) {
  ...
  struct colprintHeaderColumn *headerCol =
      xCalloc(1, struct colprintHeaderColumn);
...
static void colprintHeaderPrint(ptrArray *header, unsigned int startFrom,
                                bool withHeader, bool machinable, FILE *fp) {
  unsigned int i;
...
static void colprintLinePrint(stringList *line, unsigned int startFrom,
                              ptrArray *header, bool machinable, FILE *fp) {
  unsigned int i;
...
static void colprintLinesPrint(ptrArray *lines, unsigned int startFrom,
                               ptrArray *header, bool machinable, FILE *fp) {
  unsigned int i;
...
static void colprintUpdateMaxWidths(ptrArray *header, ptrArray *lines,
...
void colprintTablePrint(struct colprintTable *table, unsigned int startFrom,
                        bool withHeader, bool machinable, FILE *fp) {
...
void colprintTableSort(struct colprintTable *table,
                       int (*compareFn)(struct colprintLine *,
                                        struct colprintLine *)) {
