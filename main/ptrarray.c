...
extern void *ptrArrayItem(const ptrArray *const current,
...
static bool ptrEq(const void *ptr, void *userData) { return (ptr == userData); }
...
extern void ptrArraySort(ptrArray *const current,
